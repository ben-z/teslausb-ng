...
class TestSpaceInfo:
    ...
    def test_cannot_snapshot_when_cam_size_zero(self):
        ...
        assert not info.can_snapshot  # System not initialized
...
class TestSpaceManager:
    ...
    def test_get_space_info_with_cam_size_zero(self, mock_fs: MockFilesystem, snapshot_manager: SnapshotManager):
        """Test get_space_info when cam_size is 0 (not initialized)."""
        mock_fs.set_free_space(100 * GB)
